<template>
  <div class='footer'>
      ...
      <br/>
      <br/>
      <span class="copyright">版权所有 努力加油</span>
      <el-drawer
        title="联系我"
        :visible.sync="drawer"
        :direction="direction"
        ...
        <p class='info'>
          <i class="el-icon-phone"></i>电话：15871782838<br/>
          <i class="el-icon-message"></i>邮箱：466974103@qq.com<br/>
          <i class="el-icon-message"></i>博客：https://blog.csdn.net/weixin_42542422<br/>
          <i class="el-icon-message"></i>github：https://github.com/Justdo1tv1<br/>
        </p>
      </el-drawer>
  </div>
</template>
